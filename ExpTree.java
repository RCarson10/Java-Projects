...
public class ExpTree
{
	...
	// preOrder - returns a String which is the result of an preorder traversal (N L R)
	...
	//recursivePreOrder - returns a String which is the result of an preorder traversal of this subtree
	...
	public double recursiveEvaluate(ExpNode subTree)//Goes through the tree pulling out each operator and repeating until a number is found
	{
		if(subTree.data.equals("/"))
		{
			if(recursiveEvaluate(subTree.right) == 0)
				throw new ArithmeticException("Dividing by zero is illegal in the world of math");
			else
